from C_query import (
    clean_rows, parse_csv, RAW,
    filter_by_city, filter_by_course,
    sum_payments, avg_age
)
...
if __name__ == "__main__":
    data = clean_rows(parse_csv(RAW))
    print(course_summary(data, "Python"))
    print(course_summary(data, "Excel"))
    print(city_summary(data, "Tiranë"))
    print(city_summary(data, "Durrës"))
